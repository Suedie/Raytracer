...
cl /c /I"C:\vcpkg\installed\x64-windows\include" main.c camera.c canvas.c render.c scene.c vector.c
if errorlevel 1 exit /b 1

link /OUT:raytracer.exe main.obj camera.obj canvas.obj render.obj scene.obj vector.obj ^
